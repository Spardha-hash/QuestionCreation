 ...
 */
package com.internship.project.servlets;


import com.internship.project.api.mainapi;
import com.internship.project.dao.QuesDao;
import com.internship.project.entities.Question;
import com.internship.project.helper.ConnectionProvider;
...
public class QuestionServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            Question question=new Question(quesno,sub,top,subtop,obj,lev,ques,option1,option2,option3,option4);
